...
func TestParseConfigs(t *testing.T) {
	...
	assert.Equal(t, "steden", rabbitConfigs[0].Server.UserName)
	assert.Equal(t, "steden", rabbitConfigs[0].Server.Password)
	...
	assert.Equal(t, "steden", rabbitConfigs[1].Server.UserName)
	assert.Equal(t, "steden", rabbitConfigs[1].Server.Password)
